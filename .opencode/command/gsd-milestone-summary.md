...
<execution_context>
@/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/workflows/milestone-summary.md
</execution_context>
...
<process>
Read and execute the milestone-summary workflow from @/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/workflows/milestone-summary.md end-to-end.
</process>
