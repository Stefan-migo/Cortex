...
<execution_context>
@/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/workflows/plan-review-convergence.md
...
<process>
Execute the plan-review-convergence workflow from @/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/workflows/plan-review-convergence.md end-to-end.
