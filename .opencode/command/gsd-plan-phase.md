...
<execution_context>
@/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/workflows/plan-phase.md
...
<process>
Execute the plan-phase workflow from @/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/workflows/plan-phase.md end-to-end.
