...
See /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/discovery.md
...
Use /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/discovery.md.
