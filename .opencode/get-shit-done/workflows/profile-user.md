...
Key references:
- @/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/USER-PROFILE.md" "/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/AGENTS.md
```
