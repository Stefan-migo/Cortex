...
- **Global scope**: `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/notes/`)
...
2. Glob `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/notes/` — works in any directory
