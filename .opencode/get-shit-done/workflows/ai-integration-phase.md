...
<required_reading>
@/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/ai-frameworks.md
@/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/agents/gsd-eval-planner.md for instructions.
