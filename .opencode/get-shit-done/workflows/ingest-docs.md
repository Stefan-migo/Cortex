...
```bash
INIT=$(node "/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
