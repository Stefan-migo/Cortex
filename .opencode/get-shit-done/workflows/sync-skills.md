...
INSTALL_JS_GLOBAL="/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
