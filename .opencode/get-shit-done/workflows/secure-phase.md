...
```
Task(
  prompt="Read /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/SECURITY.md`
