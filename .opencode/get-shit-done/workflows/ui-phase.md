...
```markdown
Read /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/agents/gsd-ui-checker.md for instructions.
