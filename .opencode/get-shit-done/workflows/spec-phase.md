...
```bash
INIT=$(node "/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/spec.md.
