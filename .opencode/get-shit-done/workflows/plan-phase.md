...
@/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/ui-brand.md
@/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/revision-loop.md
@/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/gate-prompts.md
...
**If found:**
1. Read template: `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/tdd.md to all eligible tasks:
...
if [ "$POST_PLANNING_GAPS" = "true" ]; then
  node "/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/bin/gsd-tools.cjs" gap-analysis --phase-dir "${PHASE_DIR}"
fi
```
