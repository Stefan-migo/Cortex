...
<!-- For checkpoint task examples and patterns, see @/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/checkpoints.md -->
...
See `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
