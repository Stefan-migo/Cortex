...
Use template from `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/templates/UI-SPEC.md`
