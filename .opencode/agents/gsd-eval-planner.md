...
<required_reading>
Read `/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/ai-evals.md` before planning. This is your evaluation framework.
</required_reading>
