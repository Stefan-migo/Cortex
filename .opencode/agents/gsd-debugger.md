...
<required_reading>
@/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode
                  → checks /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done
                  → writes to /run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/hooks/
...
@/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/run/media/stefan/Nuevo vol/Proyectos/AI code setup/.opencode/get-shit-done/references/common-bug-patterns.md
